package com.plataforma.plataforma_ead.core.springdoc;
...
public class SpringDocConfig {
	...
	public OpenAPI openAPI() {
		...
		return new OpenAPI()
				...
				.tags(Arrays.asList(
						new Tag().name("Aulas").description("Gerencia as aulas"),
						new Tag().name("Cursos").description("Gerencia os cursos"),
						new Tag().name("Matrículas").description("Gerencia as matrículas"),
						new Tag().name("Módulos").description("Gerencia os módulos"),

...
public interface MatriculaRepository extends JpaRepository<Matricula, Long>, JpaSpecificationExecutor<Matricula> {
	...
	boolean podeConsultar(Long usuarioId);
	
	boolean podeConsultarMatrticula(Long matriculaId, Long usuarioId);
	
	boolean podeAcessarCurso(Long cursoId, Long usuarioId);
